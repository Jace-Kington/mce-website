    ...
    <div id = "contact-us" className = 'bg-blue-400'>
        <div className = 'flex'>
          ...
          <form  className = 'pt-20'>
            ...
            <div>
              <button className = 'text-center w-full p-3 rounded-2xl font-semibold hover:text-blue-400 text-white transition ease-in bg-blue-400 outline outline-4 outline-white hover:bg-white mt-14'>Send</button>
              <ToastContainer
  position="top-right"
  autoClose={5000}
