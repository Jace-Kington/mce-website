  ...
  return (
    <div id = "meet-us" className = 'max-w-[100%]'>
        ...
        <div className = 'justify-center flex gap-10 m-10'>
            <div>
              <Image alt = "" className = 'rounded-2xl shadow-2xl shadow-blue-400 grayscale items-center h-54 w-36 sm:h-72 sm:w-44' src = {image_2}/>
            </div>
            <div>
