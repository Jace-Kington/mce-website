    ...
    <div className=''>
      ...
      <div className='text-center text-blue-400 mt-12'>
        ...
        <div className='outline-rounded mt-20 bg-white'>
          <a className='rounded-2xl hover:bg-blue-400 hover:text-white transition shadow-md shadow-blue-400 hover:shadow-lg hover:shadow-blue-400 p-5' href="#contact-us">
            Get Started
          </a>
        </div>
      </div>
