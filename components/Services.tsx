...
const Services = () => {
  return (
    <div id = 'services-section' className = 'bg-blue-400'>
        <div className = 'text-white text-center font-semibold text-lg uppercase underline-offset-1'>Our Services</div>
         <div className = 'p-5  md:hidden'>
             <div data-aos="fade-up-right" className = 'mb-12'>
                ...
                <div className = 'text-white text-lg leading-10'>Commercial Electricians are trained specialists who perform troubleshooting, repairs, and maintenance of the electrical systems in commercial buildings. Commercial electricians can work on any commercial building including retail shops, offices, restaurants, cafes and most other workplaces. </div>
            </div>
            ...
            <div data-aos="fade-up-right" className = "mb-20 sm:ml-12 items-center">
                ...
                <div className = 'text-white leading-10'>Specialised in industrial electrical contracting on the Sunshine Coast. We provide all types of services including fault finding on heavy machinery and infrastructure. We can also assist you with your Shed power installation needs.</div>
            </div>
            <div data-aos="fade-right" className = "mb-12 items-center">
             ...
             <div data-aos="fade-up-right" className = 'mr-12 mb-12'>
                ...
                <div className = 'text-white text-lg leading-10'>Our electrical contracting services are available for residential customers. This covers everything from installation and maintenance to fault-finding, repair and upgrades.</div>
            </div>
        ...
        <div data-aos="fade-right" className = 'sm:grid hidden grid-cols-2 items-center justify-center m-10 '>
            <div data-aos="fade-up-right" className = 'mb-12'>
                <div className = 'text-white text-3xl sm:text-6xl font-bold mb-5'>Commercial</div>
                <div className = 'text-white text-lg leading-10'>Commercial Electricians are trained specialists who perform troubleshooting, repairs, and maintenance of the electrical systems in commercial buildings. Commercial electricians can work on any commercial building including retail shops, offices, restaurants, cafes and most other workplaces. </div>
            </div>
